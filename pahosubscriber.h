...
#ifndef PAHOSUBSCRIBER_H
#define PAHOSUBSCRIBER_H
...
class PahoSubscriber : public DataSubscriber
{
	Q_OBJECT
public:
	PahoSubscriber(QString brokerHost, QString clientId);
	~PahoSubscriber();
private slots:
